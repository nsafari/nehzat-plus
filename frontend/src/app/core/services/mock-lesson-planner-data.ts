...
export const mockUsers: MockUser[] = [
  ...
  },
  {
    ...
    password: 'password123',
    userType: 'branch_manager' as UserType,
    approvalStatus: 'approved' as const,
    firstName: 'مسئول',
    lastName: 'شعبه تست',
  ...
  {
    id: 7,
    username: 'headquarters.dev',
    password: 'password123',
    userType: 'headquarters' as UserType,
    approvalStatus: 'approved' as const,
    firstName: 'مقرب',
    lastName: 'مرکز',
    email: 'headquarters.dev@example.com',
  ...
  },
  {
    ...
    password: 'password123',
    userType: 'evaluator' as UserType,
    approvalStatus: 'approved' as const,
    firstName: 'ارزیاب',
    lastName: 'تست',
...
export const mockBranches: Branch[] = [
  ...
  },
  {
    ...
    name: 'شعبه شرق تهران',
    province: 'تهران',
    description: 'شعبه منطقه شرق تهران',
  ...
  },
  {
    ...
    description: 'شعبه استان خراسان رضوی',
...
export const mockCourseEnrollments = new Map<number, number[]>([
  [1, [1, 2, 3]],
  [2, [1, 2]],
]);
